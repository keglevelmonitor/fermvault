...
:: install.bat - FermVault installation (run from project directory)
...
SET "ICON_PATH=%PROJECT_DIR%\src\assets\fermenter.png"
...
SET "ICON_ICO=%PROJECT_DIR%\src\assets\fermenter.ico"
...
echo Shortcut created on Desktop: FermVault.lnk
...
echo ==========================================
echo.
echo Run FermVault from the Desktop shortcut or:
